#  tracing whole code 
# not only runnable chain manually 
# as langsmith by default only trace runnable chain 
...
os.environ['LANGCHAIN_PROJECT' ] = 'RAG ChatBot' # overwrite .env LANGCHAIN_PROJECT 
...
# ---------- traced setup steps ----------
@traceable(name="load_pdf")    # here also we can addtags , metadata as in 2 v2 config
def load_pdf(path: str):       # tags metadata can help in searching
